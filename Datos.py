...
def interfazDatos1(ventanaMain):
    ...
    ventanaDatos1.bind("<Double-Button-1>", desseleccionarFila)
    ...
    tabla.column("#", anchor=tk.CENTER, width=50)
    ...
    labelJugadores = tk.Label(ventanaDatos1, text="Jugadores:", bg="lightgray", fg="black", font=15)
